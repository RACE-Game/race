...
// use race_core::crypto::{
//     apply, decrypt, encrypt, export_rsa_pubkey, gen_chacha20, gen_rsa,
// };
// use race_core::event::Event;
// use race_core::transport::TransportT;
// use race_core::types::{CreateGameAccountParams, GameAccount, GameBundle, GetGameBundleParams};
...
//     instance: Instance,
//     context: GameContext,
//     tranpsort: Box<dyn TransportT>,
// }

// #[wasm_bindgen]
// impl Client {
//     #[wasm_bindgen]
//     pub async fn init(addr: &str) -> Result<Self, Error> {
...
//         self.dispatch_event(Event::Custom(custom_event.into()))
//             .await;
//     }
...
//     #[wasm_bindgen]
//     pub async fn create_game_account(&self) {
