...
describe('Test accounts with borsh serialization', () => {
  it('ServerAccount', () => {
    ...
    assert.deepStrictEqual(
      data,
      Buffer.from([7, 0, 0, 0, 97, 110, 32, 97, 100, 100, 114, 14, 0, 0, 0, 104, 116, 116, 112, 58, 47, 47, 102, 111, 111, 46, 98, 97, 114])
    );
    let x0 = sut.ServerAccount.deserialize(data);
  ...
  it('PlayerProfile without pfp', () => {
    ...
    let data = x.serialize();
    let x0 = sut.PlayerProfile.deserialize(data);
    assert.deepStrictEqual(x, x0);
  })
  ...
  it('PlayerProfile with pfp', () => {
    ...
    assert.deepStrictEqual(
      data,
      Buffer.from([7, 0, 0, 0, 97, 110, 32, 97, 100, 100, 114, 5, 0, 0, 0, 65, 108, 105, 99, 101, 1, 11, 0, 0, 0, 65, 119, 101, 115, 111, 109, 101, 32, 80, 70, 80])
    );
    let x0 = sut.PlayerProfile.deserialize(data);
    assert.deepStrictEqual(x, x0);
  })
  ...
  it('RegistrationAccount', () => {
    ...
    assert.deepStrictEqual(
      data,
      Buffer.from([7, 0, 0, 0, 97, 110, 32, 97, 100, 100, 114, 1, 100, 0, 1, 12, 0, 0, 0, 97, 110, 111, 116, 104, 101, 114, 32, 97, 100, 100, 114, 2, 0, 0, 0, 6, 0, 0, 0, 71, 97, 109, 101, 32, 65, 6, 0, 0, 0, 97, 100, 100, 114, 32, 48, 232, 3, 0, 0, 0, 0, 0, 0, 8, 0, 0, 0, 98, 117, 110, 100, 108, 101, 32, 48, 6, 0, 0, 0, 71, 97, 109, 101, 32, 66, 6, 0, 0, 0, 97, 100, 100, 114, 32, 49, 233, 3, 0, 0, 0, 0, 0, 0, 8, 0, 0, 0, 98, 117, 110, 100, 108, 101, 32, 49])
    );
    let x0 = sut.RegistrationAccount.deserialize(data);
    assert.deepStrictEqual(x, x0);
  })
  ...
  it('GameBundle', () => {
    ...
    assert.deepStrictEqual(
      data,
      Buffer.from([14, 0, 0, 0, 104, 116, 116, 112, 58, 47, 47, 102, 111, 111, 46, 98, 97, 114, 12, 0, 0, 0, 65, 119, 101, 115, 111, 109, 101, 32, 71, 97, 109, 101, 4, 0, 0, 0, 1, 2, 3, 4])
    );
    let x0 = sut.GameBundle.deserialize(data);
    assert.deepStrictEqual(x, x0);
  })
