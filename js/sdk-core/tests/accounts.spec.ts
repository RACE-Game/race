...
describe('Test accounts with borsh serialization', () => {
  ...
  it('GameAccount', () => {
    let x = new sut.GameAccount({
      ...
      entryType: new sut.EntryTypeCash({
